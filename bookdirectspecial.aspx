<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Fairytaleromance.aspx.cs" Inherits="_Fairytaleromance" %>
		...
		<tr>
			...
			<table style="width: 100%" align="center">
				<tr>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;Discover the energy of the Big Apple When you stay at 
					our midtown hotel. Enjoy luxury accommodations, fitness and 
					business center, concierge service and free Wi-Fi when you 
					book directly through our website. Unwind after a night on 
					the town on our roof top bar retreat to your comfortable 
					room or suite.<br />
					<br />
					Reserve your room directly and save 15%<br />
					<br />
					<span class="style4">&nbsp; DEAL INCLUDES</span><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Free Wi-Fi for 1 device<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Luxury accommodations<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Fitness and business 
					center<br />
					<br />
					*<em>Hotel Cancellation Policy is 72 hours prior to arrival</em><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<td class="w3-center">
					<img alt="" src="images/offer-2.jpg" width="361" height="307" /></td>
				</tr>
			</table>
			</td>
		</tr>
