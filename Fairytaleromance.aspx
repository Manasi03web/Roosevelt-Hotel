...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Treat your loved one to a romantic getaway in 
					Mumbai city and enjoy a complimentary bottle of champagne in 
					your room upon arrival. Take your time getting ready the 
					morning of your departure with a complimentary 1pm checkout. 
					Need a little more space to unwind? we will upgrade you to 
					the next available room type - free of charge!<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<img style="border: 0" id="img1" src="button5.jpg" height="23" width="115" alt="BOOK NOW" onmouseover="FP_swapImg(1,0,/*id*/'img1',/*url*/'button6.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img1',/*url*/'button5.jpg')" onmousedown="FP_swapImg(1,0,/*id*/'img1',/*url*/'button7.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img1',/*url*/'button6.jpg')" /><!-- MSComment="ibutton" fp-style="fp-btn: Metal Rectangle 5" fp-title="BOOK NOW" --></td>
					<td class="w3-center">
					<img alt="" src="images/fairytale%20romance.jpeg" width="361" height="307" /></td>
				</tr>
			</table>
			</td>
		</tr>
